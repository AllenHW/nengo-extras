"""
Tools for streaming input from a webcam or other camera.

Requirements
------------
gi.repository.Gst (GStreamer)
   Install using ``sudo apt-get install python-gst-1.0``
   Install to virtualenv using ``pip install vext; pip install vext.gi``
"""
